...
def banner():
    print(f"{Fore.CYAN}\n===[ 𝗟𝗨𝗖𝗜𝗙𝗘𝗥 𝗕𝗔𝗡𝗡𝗜𝗡𝗚 𝗧𝗢𝗢𝗟𝗦 ]==={Style.RESET_ALL}")
    print(Fore.YELLOW + r"""
▒▒▄▀▀▀▀▀▄▒▒▒▒▒▄▄▄▄▄▒▒▒
▒▐░▄░░░▄░▌▒▒▄█▄█▄█▄█▄▒
▒▐░▀▀░▀▀░▌▒▒▒▒▒░░░▒▒▒▒
...
▒▒▐░▀▄▀░▌▒▒▒▒▒▒░░░▒▒▒▒
╔══════════════════════════════════════════╗
║ ☠️ 𝗟𝗨𝗖𝗜𝗙𝗘𝗥  𝗕𝗨𝗚 𝗦𝗬𝗦𝗧𝗘𝗠 🏆                           ║
╠══════════════════════════════════════════╣
║ 𝐎𝐖𝐍𝐄𝐑        :  𝐋𝐮𝐜𝐢𝐟𝐞𝐫....❗❗ 🌈™                    ║
║ 𝐌𝐀𝐈𝐍 𝐂𝐑𝐄𝐃𝐈𝐓  :  𝘿𝙀𝙈𝙊𝙉_𝙀𝙔𝙀™                         ║
║ 𝐘𝐎𝐔𝐓𝐔𝐁𝐄      :  @𝐃𝐄𝐌𝐎𝐍𝐄𝐘𝐄_𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋               ║
╠══════════════════════════════════════════╣
║ 🛰️ 𝐈𝐍𝐈𝐓𝐈𝐀𝐋𝐈𝐙𝐈𝐍𝐆 𝐃𝐀𝐑𝐊 𝐓𝐄𝐑𝐌𝐈𝐍𝐀𝐋...                 ║
║ 💻 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐈𝐍𝐆 𝐓𝐎 𝐃𝐄𝐌𝐎𝐍 𝐍𝐄𝐓𝐖𝐎𝐑𝐊 [𝐎𝐊]              ║
║ ⚡ 𝐒𝐘𝐒𝐓𝐄𝐌 𝐀𝐔𝐓𝐇 : 𝐑𝐎𝐎𝐓@𝐋𝐔𝐂𝐈𝐅𝐄𝐑                     ║
║ 🔒 𝐅𝐈𝐑𝐄𝐖𝐀𝐋𝐋 : 𝐀𝐂𝐓𝐈𝐕𝐄 | 𝐏𝐑𝐎𝐓𝐎𝐂𝐎𝐋 𝐯𝟔.𝟔𝟔             ║
║ 👁  𝐌𝐎𝐍𝐈𝐓𝐎𝐑𝐈𝐍𝐆 𝐓𝐀𝐑𝐆𝐄𝐓𝐒...                         ║
║ ⚙️  𝐄𝐍𝐂𝐑𝐘𝐏𝐓𝐈𝐎𝐍 𝐋𝐀𝐘𝐄𝐑 𝐎𝐍𝐋𝐈𝐍𝐄                       ║
╠══════════════════════════════════════════╣
║ ⚠️ 𝐍𝐎𝐓𝐈𝐂𝐄 : 𝐅𝐎𝐑 𝐄𝐃𝐔𝐂𝐀𝐓𝐈𝐎𝐍𝐀𝐋 𝐏𝐔𝐑𝐏𝐎𝐒𝐄𝐒 𝐎𝐍𝐋𝐘 ⚠️   ║
║ → 𝐔𝐒𝐄 𝐓𝐇𝐈𝐒 𝐊𝐍𝐎𝐖𝐋𝐄𝐃𝐆𝐄 𝐑𝐄𝐒𝐏𝐎𝐍𝐒𝐈𝐁𝐋𝐘                ║
║ → 𝐌𝐈𝐒𝐔𝐒𝐄 𝐌𝐀𝐘 𝐋𝐄𝐀𝐃 𝐓𝐎 𝐃𝐈𝐆𝐈𝐓𝐀𝐋 𝐑𝐄𝐓𝐑𝐈𝐁𝐔𝐓𝐈𝐎𝐍 👁   ║
╚══════════════════════════════════════════╝
   ⠀⠀⠀⠀⠀⣠⣶⣶⣦⡀⠀
⠀⠀⠀⠀⠀⠀⢰⣿⣿⣿⣿⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠻⣿⣿⡿⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
while True:
    ...
    if choice == "1":
        ...
        print(f"{Fore.CYAN}👋 𝗘𝘅𝗶𝘁𝗶𝗻𝗴. 𝗦𝘁𝗮𝘆 𝘀𝗮𝗳𝗲, 𝗟𝗨𝗖𝗜𝗙𝗘𝗥 𝗕𝗔𝗡𝗡𝗜𝗡𝗚 𝗧𝗢𝗢𝗟𝗦  !")
        break
    else:
